                ...
                <div class="px-3 py-3 lg:px-5 lg:pl-3">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start">
                            ...
                            <a href="https://github.com/abhishekpatil4/cbdc-webapp" class="flex ml-2 md:mr-24">
                            ...
                            <div class="flex items-center ml-3">
                                ...
                                <div class="w-44 z-50 hidden my-4 mr-9 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                                    ...
                                    <ul class="py-1" role="none">
                                        ...
                                        <li>
                                            <Link href="/settings" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Accoutn Info</Link>
                                        </li>
                                        <li>
